...
export async function createSession(req: AuthenticatedRequest, res: Response) {
    ...
    try {
        ...
        console.log("Error in createSession controller:", (error as Error).message);
...
export async function getMyRecentSession(req: AuthenticatedRequest, res: Response) {
...
export async function joinSession(req: AuthenticatedRequest, res: Response) {
